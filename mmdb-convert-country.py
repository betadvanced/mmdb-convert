...
write_geoip_file('geoip_country', metadata, the_tree, dump_item_ipv4, fmt_item_ipv4)
write_geoip_file('geoip6_country', metadata, the_tree, dump_item_ipv6, fmt_item_ipv6)
